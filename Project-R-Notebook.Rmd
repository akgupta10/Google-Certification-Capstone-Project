...
```{r Working directory}
setwd("D:/Study/Online Courses/Coursera/Google Certification/Course 8 Capstone Project/Data_case study 1")
```

#Import CSV files and merge them into a single file
```{r}
csv_files <- list.files(path = "D:/Study/Online Courses/Coursera/Google Certification/Course 8 Capstone Project/Data_case study 1/CSV files", recursive = TRUE, full.names=TRUE)
